        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-lg border border-purple-200/30">
            ...
            <div className="space-y-12">
              <section>
                <h2 className="text-2xl font-medium text-purple-900 mb-4">Allmänna Villkor</h2>
              ...
              <section>
                <h2 className="text-2xl font-medium text-purple-900 mb-4">Bokningsvillkor</h2>
                <div className="space-y-6">
                  <div>
                    <h3 className="text-xl font-medium text-purple-900 mb-2">Avbokning</h3>
                    <p className="text-gray-700">
                  ...
                  <div>
                    <h3 className="text-xl font-medium text-purple-900 mb-2">Betalning</h3>
              ...
              <section>
                <h2 className="text-2xl font-medium text-purple-900 mb-4">Ansvarsbegränsning</h2>
                <p className="text-gray-700">
              ...
              <section>
                <h2 className="text-2xl font-medium text-purple-900 mb-4">Immateriella Rättigheter</h2>
                <p className="text-gray-700">
              ...
              <section>
                <h2 className="text-2xl font-medium text-purple-900 mb-4">Ändringar i Villkoren</h2>
                <p className="text-gray-700">
